...
pub struct WrappedScreen<CB: crate::callbacks::Callbacks = ()> {
    ...
    pub callbacks: CB,
    /// Last graphic character printed, for REP (`CSI Ps b`), which repeats it.
    ...
    fn csi_dispatch(
        ...
        match intermediates.first() {
            None => match c {
                ...
                // HPA -- horizontal position absolute, identical to CHA.
                '`' => self.screen.cha(canonicalize_params_1(params, 1)),
                // HPR -- horizontal position relative, identical to CUF.
                'a' => self.screen.cuf(canonicalize_params_1(params, 1)),
                // CHT -- cursor forward tabulation.
                'I' => {
                    for _ in 0..canonicalize_params_1(params, 1) {
                        self.screen.tab();
                    }
                }
                ...
                // HVP -- horizontal and vertical position, identical to CUP.
